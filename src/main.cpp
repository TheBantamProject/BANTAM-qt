...
const string strMessageMagic = "Bantam Signed Message:\n";
...
{
    int64_t nSubsidy = 45 * COIN;
    
    if (pindexBest->nHeight+1 == 1)
    {
      nSubsidy = 9945000 * COIN;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Bantam", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sun, 20 Dec 2015 12:58:32 GMT";
        CTransaction txNew;
        txNew.nTime = 1450616312;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1450616312;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2030807;
		if(fTestNet)
        {
            block.nNonce   = 2030807;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb2f712630b1f39fe1c55f9c48e4285a11ed437cda9c7cbf9b65b8682c9908102"));
        block.print();
